...
// Replace with your chosen font if you add custom fonts
// For example, if using Google Sans:
...
// )
// For now, we'll use default (Roboto)

val AppTypography = Typography(
    displayLarge = TextStyle(
        fontFamily = FontFamily.Default, // Replace with GoogleSans or your chosen font
